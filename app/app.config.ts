export default defineAppConfig({
	links: [ // Expects 8 exactly to fit the grid
		...
		{ to: 'https://x.com/rijkvanzanten', name: 'X', icon: 'simple-icons:x' },
		{ to: 'https://www.threads.net/@rijkvanzanten', name: 'Threads', icon: 'simple-icons:threads' },
		{ to: 'https://instagram.com/rijkvanzanten', name: 'Instagram', icon: 'simple-icons:instagram' },
	],
});
